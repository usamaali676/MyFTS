...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light">Sales /</span> Team Sales</h4>

            <div class="card">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center flex-wrap gap-3 py-3">
                    <h5 class="card-title mb-0">All sales assigned to your Customer Support team</h5>
                    <form method="GET" action="{{ route('sale.team') }}" class="d-flex align-items-center gap-2">
                        ...
                        @if($selectedCsId)
                            <a href="{{ route('sale.team') }}" class="btn btn-outline-secondary btn-sm" title="Clear filter">
                ...
                <div class="card-datatable table-responsive">
                    <table id="teamSalesTable" class="table table-bordered">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Business Name</th>
