...
<section class="hero" aria-label="Executive Summary">
  <div class="hero-inner wrapper">
    <div>
      ...
      <div class="hero-meta">
        <span class="hero-meta-item"><span class="hero-meta-dot"></span> {{ $report->landingPage->landing_page_count }} Website Pages Live</span>
        <span class="hero-meta-item"><span class="hero-meta-dot"></span> {{ $report->landingPage->keywords_count }} Keywords Tracked</span>
        <span class="hero-meta-item"><span class="hero-meta-dot"></span> {{ $report->landingPage->landing_page_count }}  Locations</span>
    ...
    <div class="hero-orbit" role="img" aria-label="127 keywords ranked #1 on Google">
      ...
      <div class="orbit-core">
        <div class="orbit-num" id="heroNum">{{ $report->landingPage->keywords_count }}</div>
  ...
  <div class="wrapper">
    ...
    <div class="kpi-grid">
      <div class="kpi-card" style="--kpi-color:var(--accent-violet)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->keywords_count }}">0</div>
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-cyan)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->backlinks_count }}">0</div>
        @if (isset($last_report) && isset($last_report->landingPage))
        @php
            $difference = $report->landingPage->backlinks_count - $last_report->landingPage->backlinks_count;
            $isUp = $difference > 0;
        @endphp
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-green)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->social_media_shares }}">0</div>
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-amber)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->social_bookmark_count }}">0</div>
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-pink)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->landing_page_count }}">0</div>
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-cyan)">
        ...
        <div class="kpi-val counter" data-target="{{ $report->landingPage->internal_links_count }}">0</div>
      ...
      <div class="kpi-card" style="--kpi-color:var(--accent-violet)">
        ...
        <div class="kpi-val" style="font-size:26px">{{ $report->landingPage->avg_pages_position }}</div>
...
<section class="section" aria-labelledby="sc-heading">
  <div class="wrapper">
    ...
    <div class="sc-grid">
      <div class="sc-stat">
        <div class="sc-val" style="color:var(--accent-violet)">{{ $report->landingPage->total_impressions }}</div>
        <div class="sc-label">Total Impressions</div>
      </div>
      <div class="sc-stat">
        <div class="sc-val" style="color:var(--accent-cyan)">{{ $report->landingPage->total_clicks }}</div>
        <div class="sc-label">Total Clicks</div>
      </div>
      <div class="sc-stat">
        <div class="sc-val" style="color:var(--accent-green)">{{ $report->landingPage->avg_ctr }}</div>
        <div class="sc-label">Avg. CTR</div>
      </div>
      <div class="sc-stat">
        <div class="sc-val" style="color:var(--accent-amber)">{{ $report->landingPage->avg_pages_position }}</div>
        <div class="sc-label">Avg. Position</div>
      </div>
      {{-- <div class="sc-stat">
        <div class="sc-val" style="color:var(--accent-pink)">{{ $report->landingPage->landing_page_count }}</div>
    ...
    <div class="section-header">
      <div class="section-title">
        ...
        <div>
          ...
          <div class="section-tag">{{ $report->landingPage->keywords_count }} keywords tracked on Google.com</div>
        </div>
      </div>
    ...
    <div class="chart-card">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody id="keyword">
            @php
                preg_match_all('/<li>(.*?)<\/li>/is', $report->landingpage->first_page_keywords, $matches);
            ...
            @endforeach
            @php
                preg_match_all('/<li>(.*?)<\/li>/is', $report->landingpage->second_page_keywords, $matches);
  ...
  <div class="wrapper">
    ...
    <div class="ai-grid">
      <div class="ai-card">
        ...
        <div class="ai-desc">Your landing pages appear in AI-generated answer panels for 42% of tracked local service queries</div>
      </div>
      <div class="ai-card">
        <div class="ai-icon">⭐</div>
  ...
  <div class="wrapper">
    ...
    <div class="eeat-grid">
      <div class="eeat-card">
        ...
        <div class="eeat-bar-bg"><div class="eeat-bar-fill" style="width:0%;background:var(--grad-violet)" data-width="{{ $report->landingpage->experience_score }}%"></div></div>
        <div class="eeat-score" style="color:var(--accent-violet)">{{ $report->landingpage->experience_score }}/100</div>
      ...
      <div class="eeat-card">
        ...
        <div class="eeat-bar-bg"><div class="eeat-bar-fill" style="width:0%;background:var(--grad-cyan)" data-width="{{ $report->landingpage->expertise_score }}%"></div></div>
        <div class="eeat-score" style="color:var(--accent-cyan)">{{ $report->landingpage->expertise_score }}/100</div>
      ...
      <div class="eeat-card">
        ...
        <div class="eeat-bar-bg"><div class="eeat-bar-fill" style="width:0%;background:var(--grad-amber)" data-width="{{ $report->landingpage->authority_score }}%"></div></div>
        <div class="eeat-score" style="color:var(--accent-amber)">{{ $report->landingpage->authority_score }}/100</div>
        <div style="font-size:11px;color:var(--text-muted);margin-top:6px">{{ $report->landingpage->backlinks_count }} quality backlinks across Diigo, Pearltrees, WordPress &amp; Blogger</div>
      </div>
      <div class="eeat-card">
        <div class="eeat-letter" style="color:var(--accent-green)">T</div>
        <div class="eeat-name">Trustworthiness</div>
        <div class="eeat-bar-bg"><div class="eeat-bar-fill" style="width:0%;background:var(--grad-cyan)" data-width="{{ $report->landingpage->trust_score }}%"></div></div>
        <div class="eeat-score" style="color:var(--accent-green)">{{ $report->landingpage->trust_score }}/100</div>
    ...
    <div class="cwv-grid">
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->lcp }} s</div>
        </div>
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->inp }}ms</div>
        </div>
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->cls }}</div>
        </div>
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->fcp }}s</div>
        </div>
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->ttfb }}ms</div>
        </div>
      ...
      <div class="cwv-card">
        <div class="cwv-dial">
          ...
          <div class="cwv-val" style="color:var(--accent-green)">{{ $report->landingpage->page_speed }}</div>
        </div>
...
<section class="section" aria-labelledby="tech-heading">
  <div class="wrapper">
    ...
    <div class="tech-grid">
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">XML Sitemap</div><div class="tech-val">Submitted &amp; indexed</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">HTTPS / SSL</div><div class="tech-val">Valid — A grade</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">robots.txt</div><div class="tech-val">Correctly configured</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Canonical Tags</div><div class="tech-val">All 8 pages set</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Meta Titles</div><div class="tech-val">Optimized, &lt;60 chars</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Meta Descriptions</div><div class="tech-val">Unique per page</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Mobile Responsive</div><div class="tech-val">Fully responsive</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Schema Markup</div><div class="tech-val">LocalBusiness + Service</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Image Alt Tags</div><div class="tech-val">100% coverage</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Header Tags (H1-H3)</div><div class="tech-val">Keyword-rich hierarchy</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Internal Linking</div><div class="tech-val">171 internal links</div></div></div>
      <div class="tech-item"><div class="tech-check check-warn">!</div><div class="tech-info"><div class="tech-name">Structured Data</div><div class="tech-val">Review schema pending</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">NAP Consistency</div><div class="tech-val">Name/Address/Phone match</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Google Business Profile</div><div class="tech-val">Verified &amp; active</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">No Broken Links</div><div class="tech-val">Zero 404 errors</div></div></div>
      <div class="tech-item"><div class="tech-check check-ok">✓</div><div class="tech-info"><div class="tech-name">Page Indexing</div><div class="tech-val">8/8 pages indexed</div></div></div>
    </div>
    <div style="margin-top:20px" class="chart-card">
      <div class="chart-card-head">
        <div>
    ...
    <div class="chart-card">
      <div class="table-wrap">
        <table>
          ...
          <tbody id="landingpagetable">
                @php
                    preg_match_all('/<li>(.*?)<\/li>/is', $report->landingpage->landing_page_urls, $matches);
...
<section class="section" aria-labelledby="bl-heading">
  <div class="wrapper">
    <div class="section-header">
      ...
      <span class="chart-pill">{{ $report->landingpage->backlinks_count }} Total Links</span>
    </div>
    <div class="chart-grid chart-grid-2" style="margin-bottom:24px">
      <div class="chart-card">
        <div class="chart-card-head">
    ...
    <div class="chart-card">
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody id="backlinks">
            @php
                preg_match_all('/<li>(.*?)<\/li>/is', $report->landingpage->blog_backlinks, $matches);
            ...
            @endforeach
              @php
                preg_match_all('/<li>(.*?)<\/li>/is', $report->landingpage->bookmark_backlinks, $matches);
...
<section class="section" aria-labelledby="ach-heading">
  <div class="wrapper">
    ...
    <div class="ach-grid">
      <div class="ach-card"><div class="ach-icon">🥇</div><div><div class="ach-title">{{ $report->landingpage->keywords_count }}  Keywords at #1</div><div class="ach-desc">Highest monthly rank count achieved — 97.7% of all tracked keywords now hold the #1 position on Google</div></div></div>
      <div class="ach-card"><div class="ach-icon">🌐</div><div><div class="ach-title">{{ $report->landingpage->landing_page_count }} Pages Fully Indexed</div><div class="ach-desc">All 8 landing pages are live, indexed, and driving local traffic from 5 target MA neighborhoods</div></div></div>
      <div class="ach-card"><div class="ach-icon">📣</div><div><div class="ach-title">{{ $report->landingpage->social_media_shares }} Social Shares</div><div class="ach-desc">Viral off-page presence built across Pinterest, Blogger, and WordPress networks</div></div></div>
      <div class="ach-card"><div class="ach-icon">🔗</div><div><div class="ach-title">{{ $report->landingpage->backlinks_count }} Backlinks Built</div><div class="ach-desc">White-hat link profile across 3+ platforms with relevant niche anchors — no spam, no risk</div></div></div>
      <div class="ach-card"><div class="ach-icon">📍</div><div><div class="ach-title">{{ $report->landingpage->landing_page_count }}-City Local Pack</div><div class="ach-desc">Dominant presence in Local Pack for Melrose, Newton, Winchester, Wellesley, &amp; Brookline markets</div></div></div>
      <div class="ach-card"><div class="ach-icon">✍️</div><div><div class="ach-title">{{ $report->landingpage->backlinks_count }} Blog Articles Published</div><div class="ach-desc">Authoritative niche content on TV mounting, home theaters, smart lighting, WiFi &amp; security cameras</div></div></div>
      <div class="ach-card"><div class="ach-icon">⚡</div><div><div class="ach-title">Core Web Vitals: Pass</div><div class="ach-desc">All CWV metrics in green — LCP 1.8s, INP 87ms, CLS 0.04 across all landing pages</div></div></div>
  ...
  <div class="wrapper">
    ...
    <div class="plan-grid">
      <div class="plan-item">
        ...
        <div><div class="plan-text">Expand to Arlington &amp; Lexington</div><div class="plan-desc">Create 2 new landing pages targeting WiFi installation and home automation in Arlington &amp; Lexington, MA to expand geographic footprint</div></div>
      ...
      <div class="plan-item">
        ...
        <div><div class="plan-text">Video Content for YouTube SEO</div><div class="plan-desc">Create 2–3 short-form installation walk-through videos — embed on landing pages to boost dwell time and capture YouTube search visibility</div></div>
      ...
      <div class="plan-item">
        ...
        <div><div class="plan-text">AI Overview Optimization</div><div class="plan-desc">Add FAQ sections with concise Q&amp;A format answers to all landing pages — structured to appear in Google AI Overviews and featured snippets</div></div>
        <div class="priority-low">Growth</div>
      </div>
    </div>
  </div>
...
const max = {{ $report->landingpage->backlinks_count }};
...
function buildCharts(){
  ...
  makeChart('rankDistChart',{
    type:'doughnut',
    data:{
      labels:['Position #1 ({{ substr_count(strtolower($report->landingpage->first_page_keywords), '<li>') }})','Position #2 ({{ substr_count(strtolower($report->landingpage->second_page_keywords), '<li>') }})'],
      datasets:[{data:[{{ substr_count(strtolower($report->landingpage->first_page_keywords), '<li>') }},{{ substr_count(strtolower($report->landingpage->second_page_keywords), '<li>') }}],backgroundColor:['rgba(111,76,255,.85)','rgba(0,212,255,.7)'],borderColor:'transparent',borderWidth:0,hoverOffset:6}]
    },
...
//   });
  ...
  makeChart('blTypeChart',{
    ...
    data:{
      ...
      datasets:[{data:[{{ $report->landingpage->social_bookmark_count }}, {{ $report->landingpage->social_media_shares }},{{ $report->landingpage->backlinks_count }}, {{ $report->landingpage->internal_links_count }}],backgroundColor:['rgba(111,76,255,.85)','rgba(0,212,255,.7)','rgba(255,179,71,.8)','rgba(0,229,160,.75)'],borderColor:'transparent',borderWidth:0,hoverOffset:6}]
    },
...
function animateCounters(){
  ...
  const updateHero = (now)=>{
    ...
    const ease = 1-Math.pow(1-progress,4);
    heroEl.textContent = Math.round(ease*{{ $report->landingPage->keywords_count }});
